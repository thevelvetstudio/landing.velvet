...
export const applyUrl = 'https://app.thevelvetstudio.co/';
export const velvetModules = [
    { id: 'app', index: '01', name: 'APP', label: 'App', layer: 'OPERATIONAL LAYER', href: 'https://app.thevelvetstudio.co/', description: 'The operational layer of VELVET. Tools, workflows and access to the ecosystem.', cta: 'Enter App' },
